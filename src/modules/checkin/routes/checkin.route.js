...
// router.post("/", AutorizacaoMiddleware.autorizar(["aluno"]), CheckinController.registrarEntrada);

// // PUT /checkins/:id - aluno (próprio) ou instrutor
// router.put("/:id", AutorizacaoMiddleware.autorizar(["aluno", "instrutor"]), CheckinController.atualizar);

// // DELETE /checkins/:id - só instrutor
// router.delete("/:id", AutorizacaoMiddleware.autorizar(["instrutor"]), CheckinController.excluir);
